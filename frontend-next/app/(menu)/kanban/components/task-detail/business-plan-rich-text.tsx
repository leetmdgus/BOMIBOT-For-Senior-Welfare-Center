...
import { ColorPaletteButton } from "@menu/kanban/components/task-detail/rich-text-color-palette"
import { RichTextTableContextMenuLayer } from "@menu/kanban/components/task-detail/rich-text-table-context-menu"
import { RichTextImageToolbarLayer } from "@menu/kanban/components/task-detail/rich-text-image-toolbar-layer"
import { RichTextTableSelectionLayer } from "@menu/kanban/components/task-detail/rich-text-table-selection-layer"
import { RichTextTableStyleToolbar } from "@menu/kanban/components/task-detail/rich-text-table-style-toolbar"
import { ClassicEditorToolbar } from "@menu/kanban/components/task-detail/classic-editor-toolbar"
import { TableInsertGrid } from "@menu/kanban/components/task-detail/table-insert-grid"
import {
  buildTableHtml,
  deleteRichTextTable,
