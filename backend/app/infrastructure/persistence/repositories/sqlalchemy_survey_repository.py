...
from app.core.datetime_kst import now_kst
...
class SqlAlchemySurveyRepository(SurveyRepository):
    ...
    def count_by_region(self, region_id: str) -> int:
        from app.infrastructure.persistence.models.survey import SurveyModel
    ...
    def list_responses(self, region_id: str, survey_id: str) -> list[SurveyResponseRecord]:
        from app.infrastructure.persistence.models.survey import SurveyResponseModel
