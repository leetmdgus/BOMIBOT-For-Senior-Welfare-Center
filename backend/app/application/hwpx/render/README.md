...
```python
from app.application.hwpx.template_merge import SectionMergeMode, merge_hwpx_bytes, merge_hwpx_files
...
| 층 | 프론트 | 백엔드 |
|----|--------|--------|
| AST | `frontend-next/lib/hwp-ast/` | `app/application/hwpx/ast/` |
