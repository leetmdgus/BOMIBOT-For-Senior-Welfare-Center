...
from app.modules.chat.assistant_llm import is_assistant_llm_configured
from app.common.http.content_disposition import attachment_content_disposition
from app.common.hwpx.ai_fill import ai_fill_form
...
from app.common.dependencies import require_region_id
...
def list_supported_document_extensions(
    ...
    from app.common.hwpx.automation.evidence_analyzer import _SUPPORTED
