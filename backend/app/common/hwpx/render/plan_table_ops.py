...
from app.common.hwpx.hwpx_image_embed import HwpxImageCatalog, inject_image_into_tc
...
from app.common.hwpx.reference_sections import REFERENCE_TEMPLATE_ROW_COUNT as REFERENCE_TABLE_ROW_COUNT
