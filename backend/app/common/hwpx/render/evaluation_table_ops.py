...
from app.common.hwpx.encoding import sanitize_hwpx_text, slot_lines
from app.common.hwpx.render.cell_fill import (
...
from app.common.hwpx.hwpx_image_embed import HwpxImageCatalog
from app.common.hwpx.render.plan_table_ops import (
    fill_reference_sections_table_json,
    fill_reference_sections_table_lxml,
)
from app.common.hwpx.section0_template_fill import HP_NS, _cells_by_addr, _set_tc_text
from app.common.hwpx.template_cell_maps import EVALUATION_MAIN_TABLE_VALUES
