...
from app.common.hwpx.section0_ok_template import (
...
def _fill_plan_main_table(tbl: etree._Element, form: dict[str, Any]) -> None:
    from app.common.hwpx.render.plan_table_ops import fill_plan_table_lxml
...
def build_section0_from_template(doc: HwpxDocument) -> bytes:
    ...
    from app.common.hwpx.section0_byte_fill import build_section0_bytes_byte_fill
