...
from app.common.hwpx.hwpx_image_embed import HwpxImageCatalog, reset_pic_ids
from typing import Any, Callable

from lxml import etree

from app.common.hwpx.encoding import escape_xml, prv_safe_value, sanitize_hwpx_text
from app.common.hwpx.reference_sections import (
    reference_prv_tail_tags,
    reference_prv_tail_values,
)
from app.common.hwpx.hwpx_templates import HwpxTemplateKind, load_section0_template_bytes
...
def rebuild_evaluation_prv_bytes(prv: bytes, evaluation: dict[str, Any]) -> bytes:
    ...
    from app.common.hwpx.render.evaluation_table_ops import resolve_evaluation_field
...
def build_plan_section0_for_download(
    ...
    *,
    ...
    from app.common.hwpx.render.plan_table_ops import fill_all_plan_tables_lxml_with_form
...
def build_evaluation_section0_for_download(
    ...
    from app.common.hwpx.render.evaluation_table_ops import (
...
def _resolve_field_value(
    ...
    *,
    ...
    if field_key in (
        ...
        from app.common.hwpx.encoding import slot_lines

        return slot_lines(str(raw or "")) or "-"
    if field_key == "evaluationDate":
        from app.common.hwpx.render.evaluation_table_ops import _format_eval_date
