...
from app.common.core.datetime_kst import format_kst_datetime, kst_year, now_kst
...
from app.modules.kanban.documents_reports import (
    build_budget_report_rows,
    build_business_plan_report,
    build_performance_report_rows,
)
from app.modules.ebooks.annual_report import (
...
from app.modules.kanban.task_detail_bootstrap import (
...
from app.common.region_store.approvals import ApprovalApplicationService
from app.common.region_store.chat_config import ChatConfigApplicationService
from app.common.region_store.document_templates import DocumentTemplateService
from app.common.region_store.gateway import RegionStoreGateway
from app.common.domain.region_store.constants import (
    DOMAIN_EBOOKS,
    DOMAIN_FILES,
    DOMAIN_ONTOLOGY,
    DOMAIN_PERFORMANCE,
...
from app.common.domain.shared.scoped_ids import strip_scope

from app.common.domain.region_store.constants import (  # noqa: E402 — re-export
    DOMAIN_APPROVALS,
    DOMAIN_CHAT,
)
...
class RegionStoreService:
    ...
    def build_annual_report_pdf(
        ...
        from app.modules.ebooks.annual_report_pdf import build_annual_report_pdf
    ...
    def build_annual_report_html(
        ...
        *,
        ...
        from app.modules.ebooks.annual_report_html import build_annual_report_html
    ...
    def complete_task_surveys(
        ...
        *,
        ...
        from app.modules.survey.survey_results_pdf import build_survey_results_pdf
    ...
    def complete_business_evaluation(
        ...
        *,
        ...
        from app.common.hwpx.task_hwpx_sync import try_sync_evaluation_hwpx
    ...
    def _collect_performance_sub_project_names(
        ...
        from app.modules.kanban.plan_sub_projects import collect_performance_sub_project_names
    ...
    def _sync_plan_sub_projects_from_performance(
        ...
        from app.modules.kanban.plan_sub_projects import merge_plan_sub_projects
    ...
    def save_task_documents(
        ...
        *,
        ...
        if plan is not None:
            ...
            from app.common.hwpx.task_hwpx_sync import try_sync_plan_hwpx
